...
signal puzzle_completed  # 🔔 Se emite al resolver el puzzle
...
func _ready():
	...
	scene_bg.anchor_left = 0
	scene_bg.anchor_top = 0
	scene_bg.anchor_right = 1
	scene_bg.anchor_bottom = 1
...
func check_if_solved():
	...
	# 🔔 Emitir señal y cerrar automáticamente
